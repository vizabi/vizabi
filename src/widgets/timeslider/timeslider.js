/* THIS CERTAINLY NEEDS REFACTORING 
   I USED THE CODE FROM ANOTHER EXPERIMENT OF MINE:
   http://fiddle.jshell.net/Mw89w/7/
*/
...
define([
    ...
    var TimeSlider = function(sandbox, options) {
        ...
        var timeslider,
            ...
            lifeAfter,
            offset = null,
            range = sandbox.state.yearRange,
            startYear = sandbox.state.year,
            playInterval,
            speed = 300;
