...
(function() {
    ...
    Vizabi.Component.extend('gapminder-treemenu', {
        ...
        alignX: function(input) { if(!arguments.length) return alignX; alignX = input; return this; },
        alignY: function(input) { if(!arguments.length) return alignY; alignY = input; return this; },
